...
alter TABLE shelter_users ADD FOREIGN KEY (animal_id) REFERENCES animals(id);
...
insert into animals (type_animal, breed, in_shelter) values ('CAT', 'Рыжий', true ), ('CAT', 'Сфинкс', true ), ('CAT', 'Дворняжка', true ), ('CAT', 'Британец', true );

-- changeset Caveri:7

insert into animals (type_animal, breed, in_shelter) values ('DOG', 'Овчарка', true), ('DOG', 'Спаниель', true), ('DOG', 'Хаски', true), ('DOG', 'Шпиц', true);
